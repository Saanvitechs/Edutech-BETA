...
//           />
//           TREx
//           {/* Book a Webinar button placed near the logo */}
//           <a 
...
const CustomNavbar = () => {
  ...
  const handleLogout = () => {
    logout();
    localStorage.removeItem('popupShown'); // Clear popupShown flag
    navigate('/login');
  };
  ...
  return (
    ...
    >
      <Container>
        ...
        {/* Move the Book a Webinar button into its own Nav.Link */}
        <Nav.Link
