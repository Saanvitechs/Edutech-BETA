...
//   'Stocks and Shares', 'Probability', 'Banker\'s Discount', 'Odd Man Out and Series'
// ];
...
//           {/* A placeholder for any potential filter bar */}
...
//             <Grid item xs={12} sm={6} md={4} lg={3} key={index} className="topic-grid-item">
