...
//       <Box sx={{ width: '400px', backgroundColor: '#000000', height: '100vh' }}>
//         <Dashboard />
//       </Box>
...
const Resource = () => {
  return (
    <Box className="resource-container">
      {/* Custom class for the Dashboard in this page */}
      <Box className="resource-dashboard" sx={{ width: '400px', backgroundColor: '#000000', height: '100vh' }}>
        <Dashboard />
      </Box>
